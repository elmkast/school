...
const issues=new Set(["QUESTION_SHAPE","FEEDBACK_FIELDS","VIGNETTE_FORMAT","VIGNETTE_LENGTH","VIGNETTE_QUESTION","STEM_QUESTION","REASONING_STEPS","CHOICES_FORMAT","DUPLICATE_CHOICES","ANSWER_INDEX","SOURCE_PAGES","SOURCE_QUOTE","SOURCE_REFERENCE","DUPLICATE_QUESTION","TOPICS_INVALID","OUTPUT_INCOMPLETE","OUTPUT_JSON"]);
