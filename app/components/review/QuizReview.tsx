...
import { nextQuestionPlan, validateQuizQuestion, QuizGenerationError } from "../../../lib/adaptive-quiz";
...
export function QuizReview(){
  ...
  const service=useMemo<QuizService>(()=>({
    ...
    async question(source,topics,progress,signal,pending=[]){
      setRequests(n=>n+1);
